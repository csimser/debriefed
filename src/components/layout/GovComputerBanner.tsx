...
export function GovComputerBanner() {
  ...
  return (
    <div className="bg-status-blue/10 border border-status-blue/20 rounded-lg p-3 mb-4">
      <div className="flex items-start gap-3">
        <svg className="w-5 h-5 text-status-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
