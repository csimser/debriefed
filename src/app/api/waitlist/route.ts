...
const MAIL_FROM_NAMED = process.env.MAIL_FROM_NAMED ?? `Debriefed <${MAIL_FROM}>`
const WAITLIST_NOTIFY_TO = process.env.WAITLIST_NOTIFY_TO ?? MAIL_FROM
