    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 text-center">
          {hasError ? (
            <>
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-status-red-dim flex items-center justify-center">
                <svg className="w-10 h-10 text-status-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <>
              ...
              <p className="text-text-muted mb-8">
                You&apos;ve been unsubscribed from Debriefed marketing emails.
              </p>
            </>
          )}
