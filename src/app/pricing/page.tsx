        ...
        <div className="max-w-3xl mx-auto mt-16">
          ...
          <div className="space-y-4">
            ...
            <FaqItem
              ...
              answer="Yes — if you're unsatisfied within 7 days of purchase, contact support@getdebriefed.co for a refund."
            />
            <FaqItem
            ...
            <FaqItem
              ...
              answer="Yes — contact support@getdebriefed.co and we'll help you upgrade. Your remaining Core time will be factored in."
            />
          </div>
        </div>
      </section>
