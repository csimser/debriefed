...
const FAQ_ITEMS = [
  ...
  { q: 'How do I cancel or get a refund?', a: "Debriefed uses one-time purchases, not recurring subscriptions - so there's nothing to cancel. If you're unsatisfied within 7 days of purchase, contact support@getdebriefed.co for refund consideration." },
  ...
  { q: "Why isn't my data saving?", a: "Check your internet connection. Debriefed auto-saves your work but requires connectivity. If issues persist, try refreshing the page. Contact support@getdebriefed.co if problems continue." },
