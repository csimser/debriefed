...
export default async function BlogPostPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    publisher: { '@type': 'Organization', name: 'Debriefed', url: APP_URL },
  }
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: CATEGORY_LABELS[post.category] || post.category, item: `${APP_URL}/blog?category=${post.category}` },
