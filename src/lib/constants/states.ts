/**
 * US States and Territories for address dropdown
 * Includes military APO/FPO addresses for veterans overseas
 */
...
export function getStateName(abbrev: string): string {
  ...
  return state?.label || abbrev
}

/**
 * Format city and state for display: "San Diego, CA"
 */
